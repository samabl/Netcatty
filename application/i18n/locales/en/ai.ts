...
export const enAiMessages: Messages = {
  ...
  'ai.externalMcp.client.other': 'Other',
  ...
  'ai.externalMcp.cursor.description': 'Merge this into your Cursor MCP configuration without replacing existing servers.',
  'ai.externalMcp.other.description': 'Copy the setup prompt into another terminal agent, or merge the MCP snippet into its client configuration.',
  ...
  'ai.mcpServers.title': 'MCP Servers',
  'ai.mcpServers.description': 'Connect Catty to third-party MCP servers so their tools become available in chat. Tool names are namespaced and follow Settings -> AI -> Safety: observer mode blocks them, confirm mode asks before each call.',
  'ai.mcpServers.empty': 'No MCP servers configured yet.',
  'ai.mcpServers.add': 'Add Server',
  'ai.mcpServers.addTitle': 'Add MCP Server',
  'ai.mcpServers.editTitle': 'Edit MCP Server',
  'ai.mcpServers.name': 'Name',
  'ai.mcpServers.name.placeholder': 'e.g. Files',
  'ai.mcpServers.transport': 'Transport',
  'ai.mcpServers.transport.stdio': 'stdio (local command)',
  'ai.mcpServers.transport.http': 'Streamable HTTP',
  'ai.mcpServers.transport.sse': 'SSE',
  'ai.mcpServers.command': 'Command',
  'ai.mcpServers.command.placeholder': 'npx',
  'ai.mcpServers.args': 'Arguments',
  'ai.mcpServers.args.placeholder': 'One argument per line',
  'ai.mcpServers.cwd': 'Working directory',
  'ai.mcpServers.cwd.placeholder': 'Optional',
  'ai.mcpServers.env': 'Environment variables',
  'ai.mcpServers.env.placeholder': 'KEY=value, one per line',
  'ai.mcpServers.url': 'Server URL',
  'ai.mcpServers.url.placeholder': 'https://mcp.example.com/mcp',
  'ai.mcpServers.headers': 'HTTP headers',
  'ai.mcpServers.headers.placeholder': 'Authorization=Bearer ..., one per line',
  'ai.mcpServers.secretsNote': 'Values are encrypted with the OS credential store before being saved.',
  'ai.mcpServers.autoApprove': 'Skip approval for this server',
  'ai.mcpServers.autoApprove.description': 'Run the tools of this server without the per-call approval prompt. Observer mode still blocks them.',
  'ai.mcpServers.toolAllowlist': 'Allowed tools',
  'ai.mcpServers.toolAllowlist.placeholder': 'One tool name per line. Empty exposes every tool.',
  'ai.mcpServers.status.connected': 'Connected',
  'ai.mcpServers.status.connecting': 'Connecting',
  'ai.mcpServers.status.disabled': 'Disabled',
  'ai.mcpServers.status.error': 'Error',
  'ai.mcpServers.toolCount': '{count} tools',
  'ai.mcpServers.refresh': 'Refresh',
  'ai.mcpServers.save': 'Save',
  'ai.mcpServers.cancel': 'Cancel',
  'ai.mcpServers.edit': 'Edit',
  'ai.mcpServers.delete': 'Delete',
  'ai.mcpServers.confirmDelete': 'Delete MCP server "{name}"?',
  'ai.mcpServers.import': 'Import JSON',
  'ai.mcpServers.import.title': 'Import MCP servers from JSON',
  'ai.mcpServers.import.description': 'Paste a Claude Desktop, Cursor, VS Code, or Cline MCP JSON document, or choose a .json file. A server whose name already exists is updated in place; the rest are added.',
  'ai.mcpServers.import.placeholder': '{\n  "mcpServers": {\n    "files": { "command": "npx", "args": ["-y", "@modelcontextprotocol/server-filesystem", "/tmp"] }\n  }\n}',
  'ai.mcpServers.import.chooseFile': 'Choose file',
  'ai.mcpServers.import.summary': '{added} new, {updated} updated',
  'ai.mcpServers.import.badge.add': 'New',
  'ai.mcpServers.import.badge.update': 'Update',
  'ai.mcpServers.import.skipped': 'Skipped {count} entry/entries',
  'ai.mcpServers.import.unnamed': '(unnamed)',
  'ai.mcpServers.import.skip.invalidEntry': 'not a runnable server',
  'ai.mcpServers.import.skip.limitReached': 'import limit reached',
  'ai.mcpServers.import.error.invalidJson': 'That is not valid JSON.',
  'ai.mcpServers.import.error.unsupportedShape': 'No MCP server definitions found. Use an "mcpServers" or "servers" object, a server array, or a single server object.',
  'ai.mcpServers.import.fileError': 'Could not read that file.',
  'ai.mcpServers.import.imported': 'Applied {count} MCP server(s).',
  'ai.mcpServers.import.confirm': 'Import',
  'ai.mcpServers.import.cancel': 'Cancel',
  'ai.mcpServers.error.nameRequired': 'Name is required.',
  'ai.mcpServers.error.commandRequired': 'Command is required for stdio servers.',
  'ai.mcpServers.error.urlRequired': 'Server URL is required.',
  'ai.mcpServers.error.urlInvalid': 'Enter a valid http(s) URL.',
  'ai.mcpServers.bridgeUnavailable': 'The MCP client bridge is unavailable in this environment.',
  ...
  'terminal.layer.layoutSavedAsDefault': 'Layout saved as default',
  'terminal.layer.layoutSaveFailed': 'Could not save layout',
