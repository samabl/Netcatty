...
export const zhCNAiMessages: Messages = {
  ...
  'ai.externalMcp.cursor.description': '将片段合并到 Cursor MCP 配置中，并保留已有服务器。',
  'ai.externalMcp.other.description': '将安装提示词复制到其他终端 Agent，或把 MCP 片段合并到对应客户端配置。',
  ...
  'ai.mcpServers.title': 'MCP 服务器',
  'ai.mcpServers.description': '让 Catty 连接第三方 MCP 服务器，把它们的工具接入对话。工具名带命名空间，并遵循「设置 -> AI -> 安全」：观察模式会拒绝，确认模式每次调用前询问。',
  'ai.mcpServers.empty': '还没有配置 MCP 服务器。',
  'ai.mcpServers.add': '添加服务器',
  'ai.mcpServers.addTitle': '添加 MCP 服务器',
  'ai.mcpServers.editTitle': '编辑 MCP 服务器',
  'ai.mcpServers.name': '名称',
  'ai.mcpServers.name.placeholder': '例如 Files',
  'ai.mcpServers.transport': '传输方式',
  'ai.mcpServers.transport.stdio': 'stdio（本地命令）',
  ...
  'ai.mcpServers.args': '参数',
  'ai.mcpServers.args.placeholder': '每行一个参数',
  'ai.mcpServers.cwd': '工作目录',
  'ai.mcpServers.cwd.placeholder': '可选',
  'ai.mcpServers.env': '环境变量',
  'ai.mcpServers.env.placeholder': 'KEY=value，每行一个',
  'ai.mcpServers.url': '服务器地址',
  'ai.mcpServers.url.placeholder': 'https://mcp.example.com/mcp',
  'ai.mcpServers.headers': 'HTTP 请求头',
  'ai.mcpServers.headers.placeholder': 'Authorization=Bearer ...，每行一个',
  'ai.mcpServers.secretsNote': '所有值在保存前都会用系统凭据存储加密。',
  'ai.mcpServers.autoApprove': '此服务器免审批',
  'ai.mcpServers.autoApprove.description': '执行该服务器的工具时不再逐次弹出审批。观察模式仍会拒绝。',
  'ai.mcpServers.toolAllowlist': '允许的工具',
  'ai.mcpServers.toolAllowlist.placeholder': '每行一个工具名。留空表示暴露全部工具。',
  'ai.mcpServers.status.connected': '已连接',
  'ai.mcpServers.status.connecting': '连接中',
  'ai.mcpServers.status.disabled': '已禁用',
  'ai.mcpServers.status.error': '错误',
  'ai.mcpServers.toolCount': '{count} 个工具',
  'ai.mcpServers.refresh': '刷新',
  'ai.mcpServers.save': '保存',
  'ai.mcpServers.cancel': '取消',
  'ai.mcpServers.edit': '编辑',
  'ai.mcpServers.delete': '删除',
  'ai.mcpServers.confirmDelete': '删除 MCP 服务器「{name}」？',
  'ai.mcpServers.import': '导入 JSON',
  'ai.mcpServers.import.title': '从 JSON 导入 MCP 服务器',
  'ai.mcpServers.import.description': '粘贴 Claude Desktop、Cursor、VS Code 或 Cline 的 MCP JSON 配置，或选择 .json 文件。同名服务器会就地更新，其余为新增。',
  'ai.mcpServers.import.placeholder': '{\n  "mcpServers": {\n    "files": { "command": "npx", "args": ["-y", "@modelcontextprotocol/server-filesystem", "/tmp"] }\n  }\n}',
  'ai.mcpServers.import.chooseFile': '选择文件',
  'ai.mcpServers.import.summary': '新增 {added} 个，更新 {updated} 个',
  'ai.mcpServers.import.badge.add': '新增',
  'ai.mcpServers.import.badge.update': '更新',
  'ai.mcpServers.import.skipped': '跳过 {count} 条',
  'ai.mcpServers.import.unnamed': '（未命名）',
  'ai.mcpServers.import.skip.invalidEntry': '不是可运行的服务器',
  'ai.mcpServers.import.skip.limitReached': '已达导入上限',
  'ai.mcpServers.import.error.invalidJson': '不是有效的 JSON。',
  'ai.mcpServers.import.error.unsupportedShape': '没有找到 MCP 服务器定义。请使用 "mcpServers" 或 "servers" 对象、服务器数组或单个服务器对象。',
  'ai.mcpServers.import.fileError': '无法读取该文件。',
  'ai.mcpServers.import.imported': '已应用 {count} 个 MCP 服务器。',
  'ai.mcpServers.import.confirm': '导入',
  'ai.mcpServers.import.cancel': '取消',
  'ai.mcpServers.error.nameRequired': '请填写名称。',
  'ai.mcpServers.error.commandRequired': 'stdio 服务器必须填写命令。',
  'ai.mcpServers.error.urlRequired': '请填写服务器地址。',
  'ai.mcpServers.error.urlInvalid': '请输入有效的 http(s) 地址。',
  'ai.mcpServers.bridgeUnavailable': '当前环境不可用 MCP 客户端桥接。',
  ...
  'terminal.layer.layoutSavedAsDefault': '布局已保存为默认',
  'terminal.layer.layoutSaveFailed': '布局保存失败',
