...
export const ruAiMessages: Messages = {
  ...
  'ai.externalMcp.client.other': 'Другие',
  ...
  'ai.externalMcp.cursor.description': 'Добавьте этот фрагмент в конфигурацию MCP Cursor, сохранив существующие серверы.',
  'ai.externalMcp.other.description': 'Скопируйте запрос установки в другой терминальный агент или добавьте фрагмент MCP в конфигурацию его клиента.',
  ...
  'ai.mcpServers.title': 'MCP-серверы',
  'ai.mcpServers.description': 'Подключите Catty к сторонним MCP-серверам, чтобы их инструменты были доступны в чате. Имена инструментов получают пространство имён и подчиняются разделу Настройки -> ИИ -> Безопасность: режим наблюдателя их блокирует, режим подтверждения спрашивает перед каждым вызовом.',
  'ai.mcpServers.empty': 'MCP-серверы пока не настроены.',
  'ai.mcpServers.add': 'Добавить сервер',
  'ai.mcpServers.addTitle': 'Добавить MCP-сервер',
  'ai.mcpServers.editTitle': 'Изменить MCP-сервер',
  'ai.mcpServers.name': 'Название',
  'ai.mcpServers.name.placeholder': 'например Files',
  'ai.mcpServers.transport': 'Транспорт',
  'ai.mcpServers.transport.stdio': 'stdio (локальная команда)',
  'ai.mcpServers.transport.http': 'Streamable HTTP',
  'ai.mcpServers.transport.sse': 'SSE',
  'ai.mcpServers.command': 'Команда',
  'ai.mcpServers.command.placeholder': 'npx',
  'ai.mcpServers.args': 'Аргументы',
  'ai.mcpServers.args.placeholder': 'Один аргумент в строке',
  'ai.mcpServers.cwd': 'Рабочий каталог',
  'ai.mcpServers.cwd.placeholder': 'Необязательно',
  'ai.mcpServers.env': 'Переменные окружения',
  'ai.mcpServers.env.placeholder': 'КЛЮЧ=значение, по одному в строке',
  'ai.mcpServers.url': 'URL сервера',
  'ai.mcpServers.url.placeholder': 'https://mcp.example.com/mcp',
  'ai.mcpServers.headers': 'HTTP-заголовки',
  'ai.mcpServers.headers.placeholder': 'Authorization=Bearer ..., по одному в строке',
  'ai.mcpServers.secretsNote': 'Значения шифруются системным хранилищем учётных данных перед сохранением.',
  'ai.mcpServers.autoApprove': 'Не запрашивать подтверждение для этого сервера',
  'ai.mcpServers.autoApprove.description': 'Выполнять инструменты этого сервера без запроса подтверждения на каждый вызов. Режим наблюдателя по-прежнему их блокирует.',
  'ai.mcpServers.toolAllowlist': 'Разрешённые инструменты',
  'ai.mcpServers.toolAllowlist.placeholder': 'Одно имя инструмента в строке. Пусто — доступны все.',
  'ai.mcpServers.status.connected': 'Подключён',
  'ai.mcpServers.status.connecting': 'Подключение',
  'ai.mcpServers.status.disabled': 'Отключён',
  'ai.mcpServers.status.error': 'Ошибка',
  'ai.mcpServers.toolCount': 'Инструментов: {count}',
  'ai.mcpServers.refresh': 'Обновить',
  'ai.mcpServers.save': 'Сохранить',
  'ai.mcpServers.cancel': 'Отмена',
  'ai.mcpServers.edit': 'Изменить',
  'ai.mcpServers.delete': 'Удалить',
  'ai.mcpServers.confirmDelete': 'Удалить MCP-сервер "{name}"?',
  'ai.mcpServers.import': 'Импорт JSON',
  'ai.mcpServers.import.title': 'Импорт MCP-серверов из JSON',
  'ai.mcpServers.import.description': 'Вставьте конфигурацию MCP из Claude Desktop, Cursor, VS Code или Cline либо выберите файл .json. Серверы с существующим именем обновляются на месте, остальные добавляются.',
  'ai.mcpServers.import.placeholder': '{\n  "mcpServers": {\n    "files": { "command": "npx", "args": ["-y", "@modelcontextprotocol/server-filesystem", "/tmp"] }\n  }\n}',
  'ai.mcpServers.import.chooseFile': 'Выбрать файл',
  'ai.mcpServers.import.summary': 'Новых: {added}, обновлено: {updated}',
  'ai.mcpServers.import.badge.add': 'Новый',
  'ai.mcpServers.import.badge.update': 'Обновление',
  'ai.mcpServers.import.skipped': 'Пропущено записей: {count}',
  'ai.mcpServers.import.unnamed': '(без имени)',
  'ai.mcpServers.import.skip.invalidEntry': 'не является запускаемым сервером',
  'ai.mcpServers.import.skip.limitReached': 'достигнут предел импорта',
  'ai.mcpServers.import.error.invalidJson': 'Это не корректный JSON.',
  'ai.mcpServers.import.error.unsupportedShape': 'Определения MCP-серверов не найдены. Используйте объект "mcpServers" или "servers", массив серверов или один объект сервера.',
  'ai.mcpServers.import.fileError': 'Не удалось прочитать файл.',
  'ai.mcpServers.import.imported': 'Применено MCP-серверов: {count}.',
  'ai.mcpServers.import.confirm': 'Импортировать',
  'ai.mcpServers.import.cancel': 'Отмена',
  'ai.mcpServers.error.nameRequired': 'Укажите название.',
  'ai.mcpServers.error.commandRequired': 'Для stdio-сервера нужна команда.',
  'ai.mcpServers.error.urlRequired': 'Укажите URL сервера.',
  'ai.mcpServers.error.urlInvalid': 'Введите корректный URL http(s).',
  'ai.mcpServers.bridgeUnavailable': 'Мост MCP-клиента недоступен в этой среде.',
