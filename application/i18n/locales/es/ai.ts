...
export const esAiMessages: Messages = {
  ...
  'ai.externalMcp.client.other': 'Otros',
  ...
  'ai.externalMcp.cursor.title': 'Cursor',
  'ai.externalMcp.cursor.description': 'Combina esto con la configuración MCP de Cursor sin reemplazar los servidores existentes.',
  'ai.externalMcp.other.description': 'Copia el prompt de instalación en otro agente de terminal o combina el fragmento MCP con la configuración de su cliente.',
  ...
  'ai.mcpServers.title': 'Servidores MCP',
  'ai.mcpServers.description': 'Conecta Catty a servidores MCP de terceros para usar sus herramientas en el chat. Los nombres van con espacio de nombres y respetan Ajustes -> IA -> Seguridad: el modo observador las bloquea y el modo confirmar pregunta antes de cada llamada.',
  'ai.mcpServers.empty': 'Todavia no hay servidores MCP configurados.',
  'ai.mcpServers.add': 'Anadir servidor',
  'ai.mcpServers.addTitle': 'Anadir servidor MCP',
  'ai.mcpServers.editTitle': 'Editar servidor MCP',
  'ai.mcpServers.name': 'Nombre',
  'ai.mcpServers.name.placeholder': 'p. ej. Files',
  'ai.mcpServers.transport': 'Transporte',
  'ai.mcpServers.transport.stdio': 'stdio (comando local)',
  'ai.mcpServers.transport.http': 'Streamable HTTP',
  'ai.mcpServers.transport.sse': 'SSE',
  'ai.mcpServers.command': 'Comando',
  'ai.mcpServers.command.placeholder': 'npx',
  'ai.mcpServers.args': 'Argumentos',
  'ai.mcpServers.args.placeholder': 'Un argumento por linea',
  'ai.mcpServers.cwd': 'Directorio de trabajo',
  'ai.mcpServers.cwd.placeholder': 'Opcional',
  'ai.mcpServers.env': 'Variables de entorno',
  'ai.mcpServers.env.placeholder': 'CLAVE=valor, una por linea',
  'ai.mcpServers.url': 'URL del servidor',
  'ai.mcpServers.url.placeholder': 'https://mcp.example.com/mcp',
  'ai.mcpServers.headers': 'Cabeceras HTTP',
  'ai.mcpServers.headers.placeholder': 'Authorization=Bearer ..., una por linea',
  'ai.mcpServers.secretsNote': 'Los valores se cifran con el almacen de credenciales del sistema antes de guardarse.',
  'ai.mcpServers.autoApprove': 'Omitir la aprobacion para este servidor',
  'ai.mcpServers.autoApprove.description': 'Ejecuta las herramientas de este servidor sin pedir aprobacion en cada llamada. El modo observador sigue bloqueandolas.',
  'ai.mcpServers.toolAllowlist': 'Herramientas permitidas',
  'ai.mcpServers.toolAllowlist.placeholder': 'Un nombre de herramienta por linea. Vacio expone todas.',
  'ai.mcpServers.status.connected': 'Conectado',
  'ai.mcpServers.status.connecting': 'Conectando',
  'ai.mcpServers.status.disabled': 'Desactivado',
  'ai.mcpServers.status.error': 'Error',
  'ai.mcpServers.toolCount': '{count} herramientas',
  'ai.mcpServers.refresh': 'Actualizar',
  'ai.mcpServers.save': 'Guardar',
  'ai.mcpServers.cancel': 'Cancelar',
  'ai.mcpServers.edit': 'Editar',
  'ai.mcpServers.delete': 'Eliminar',
  'ai.mcpServers.confirmDelete': 'Eliminar el servidor MCP "{name}"?',
  'ai.mcpServers.import': 'Importar JSON',
  'ai.mcpServers.import.title': 'Importar servidores MCP desde JSON',
  'ai.mcpServers.import.description': 'Pega una configuracion MCP de Claude Desktop, Cursor, VS Code o Cline, o elige un archivo .json. Los servidores cuyo nombre ya existe se actualizan en el sitio; el resto se anaden.',
  'ai.mcpServers.import.placeholder': '{\n  "mcpServers": {\n    "files": { "command": "npx", "args": ["-y", "@modelcontextprotocol/server-filesystem", "/tmp"] }\n  }\n}',
  'ai.mcpServers.import.chooseFile': 'Elegir archivo',
  'ai.mcpServers.import.summary': '{added} nuevos, {updated} actualizados',
  'ai.mcpServers.import.badge.add': 'Nuevo',
  'ai.mcpServers.import.badge.update': 'Actualizar',
  'ai.mcpServers.import.skipped': 'Se omitieron {count} entrada(s)',
  'ai.mcpServers.import.unnamed': '(sin nombre)',
  'ai.mcpServers.import.skip.invalidEntry': 'no es un servidor ejecutable',
  'ai.mcpServers.import.skip.limitReached': 'limite de importacion alcanzado',
  'ai.mcpServers.import.error.invalidJson': 'Eso no es JSON valido.',
  'ai.mcpServers.import.error.unsupportedShape': 'No se encontraron definiciones de servidores MCP. Usa un objeto "mcpServers" o "servers", un array de servidores o un unico objeto de servidor.',
  'ai.mcpServers.import.fileError': 'No se pudo leer ese archivo.',
  'ai.mcpServers.import.imported': 'Se aplicaron {count} servidor(es) MCP.',
  'ai.mcpServers.import.confirm': 'Importar',
  'ai.mcpServers.import.cancel': 'Cancelar',
  'ai.mcpServers.error.nameRequired': 'El nombre es obligatorio.',
  'ai.mcpServers.error.commandRequired': 'El comando es obligatorio para servidores stdio.',
  'ai.mcpServers.error.urlRequired': 'La URL del servidor es obligatoria.',
  'ai.mcpServers.error.urlInvalid': 'Introduce una URL http(s) valida.',
  'ai.mcpServers.bridgeUnavailable': 'El puente del cliente MCP no esta disponible en este entorno.',
