...
export const zhTWAiMessages: Messages = {
  ...
  'ai.externalMcp.client.other': '其他',
  ...
  'ai.externalMcp.cursor.description': '將片段合併到 Cursor MCP 設定中，並保留已有伺服器。',
  'ai.externalMcp.other.description': '將安裝提示詞複製到其他終端 Agent，或把 MCP 片段合併到對應用戶端設定。',
  ...
  'ai.mcpServers.title': 'MCP 伺服器',
  'ai.mcpServers.description': '讓 Catty 連接第三方 MCP 伺服器，把它們的工具接入對話。工具名稱帶命名空間，並遵循「設定 -> AI -> 安全性」：觀察模式會拒絕，確認模式每次呼叫前詢問。',
  'ai.mcpServers.empty': '還沒有設定 MCP 伺服器。',
  'ai.mcpServers.add': '新增伺服器',
  'ai.mcpServers.addTitle': '新增 MCP 伺服器',
  'ai.mcpServers.editTitle': '編輯 MCP 伺服器',
  'ai.mcpServers.name': '名稱',
  'ai.mcpServers.name.placeholder': '例如 Files',
  'ai.mcpServers.transport': '傳輸方式',
  'ai.mcpServers.transport.stdio': 'stdio（本機命令）',
  'ai.mcpServers.transport.http': 'Streamable HTTP',
  'ai.mcpServers.transport.sse': 'SSE',
  'ai.mcpServers.command': '命令',
  'ai.mcpServers.command.placeholder': 'npx',
  'ai.mcpServers.args': '參數',
  'ai.mcpServers.args.placeholder': '每行一個參數',
  'ai.mcpServers.cwd': '工作目錄',
  'ai.mcpServers.cwd.placeholder': '選填',
  'ai.mcpServers.env': '環境變數',
  'ai.mcpServers.env.placeholder': 'KEY=value，每行一個',
  'ai.mcpServers.url': '伺服器位址',
  'ai.mcpServers.url.placeholder': 'https://mcp.example.com/mcp',
  'ai.mcpServers.headers': 'HTTP 標頭',
  'ai.mcpServers.headers.placeholder': 'Authorization=Bearer ...，每行一個',
  'ai.mcpServers.secretsNote': '所有值在儲存前都會用系統憑證儲存加密。',
  'ai.mcpServers.autoApprove': '此伺服器免審批',
  'ai.mcpServers.autoApprove.description': '執行此伺服器的工具時不再逐次彈出審批。觀察模式仍會拒絕。',
  'ai.mcpServers.toolAllowlist': '允許的工具',
  'ai.mcpServers.toolAllowlist.placeholder': '每行一個工具名稱。留空表示公開全部工具。',
  'ai.mcpServers.status.connected': '已連線',
  'ai.mcpServers.status.connecting': '連線中',
  'ai.mcpServers.status.disabled': '已停用',
  'ai.mcpServers.status.error': '錯誤',
  'ai.mcpServers.toolCount': '{count} 個工具',
  'ai.mcpServers.refresh': '重新整理',
  'ai.mcpServers.save': '儲存',
  'ai.mcpServers.cancel': '取消',
  'ai.mcpServers.edit': '編輯',
  'ai.mcpServers.delete': '刪除',
  'ai.mcpServers.confirmDelete': '刪除 MCP 伺服器「{name}」？',
  'ai.mcpServers.import': '匯入 JSON',
  'ai.mcpServers.import.title': '從 JSON 匯入 MCP 伺服器',
  'ai.mcpServers.import.description': '貼上 Claude Desktop、Cursor、VS Code 或 Cline 的 MCP JSON 設定，或選擇 .json 檔案。同名伺服器會就地更新，其餘為新增。',
  'ai.mcpServers.import.placeholder': '{\n  "mcpServers": {\n    "files": { "command": "npx", "args": ["-y", "@modelcontextprotocol/server-filesystem", "/tmp"] }\n  }\n}',
  'ai.mcpServers.import.chooseFile': '選擇檔案',
  'ai.mcpServers.import.summary': '新增 {added} 個，更新 {updated} 個',
  'ai.mcpServers.import.badge.add': '新增',
  'ai.mcpServers.import.badge.update': '更新',
  'ai.mcpServers.import.skipped': '略過 {count} 筆',
  'ai.mcpServers.import.unnamed': '（未命名）',
  'ai.mcpServers.import.skip.invalidEntry': '不是可執行的伺服器',
  'ai.mcpServers.import.skip.limitReached': '已達匯入上限',
  'ai.mcpServers.import.error.invalidJson': '不是有效的 JSON。',
  'ai.mcpServers.import.error.unsupportedShape': '找不到 MCP 伺服器定義。請使用 "mcpServers" 或 "servers" 物件、伺服器陣列或單一伺服器物件。',
  'ai.mcpServers.import.fileError': '無法讀取該檔案。',
  'ai.mcpServers.import.imported': '已套用 {count} 個 MCP 伺服器。',
  'ai.mcpServers.import.confirm': '匯入',
  'ai.mcpServers.import.cancel': '取消',
  'ai.mcpServers.error.nameRequired': '請填寫名稱。',
  'ai.mcpServers.error.commandRequired': 'stdio 伺服器必須填寫命令。',
  'ai.mcpServers.error.urlRequired': '請填寫伺服器位址。',
  'ai.mcpServers.error.urlInvalid': '請輸入有效的 http(s) 位址。',
  'ai.mcpServers.bridgeUnavailable': '目前環境無法使用 MCP 用戶端橋接。',
  ...
  'terminal.layer.layoutSavedAsDefault': '佈局已儲存為預設',
  'terminal.layer.layoutSaveFailed': '佈局儲存失敗',
